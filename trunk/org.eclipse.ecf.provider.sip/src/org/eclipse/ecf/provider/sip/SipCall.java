...
public class SipCall {
	...
	public void createCallRequest() throws SipException, ParseException, InvalidArgumentException, SdpParseException, IOException {
			...
			// create Request URI
			SipURI requestURI = addressFactory.createSipURI(receiverID
	...
	public void acceptIncomingCall() throws SdpException, IOException {
		try {
			if (inviteSTid.getState() != TransactionState.COMPLETED) {
				...
				// INVITE REQUEST
//				SessionDescriptionImpl sdpImpl = new SessionDescriptionImpl();
...
//					(SipUriID) new SipUriNamespace()
//							.createInstance(new Object[] { "sip:2233369447@sip2sip.info" }),
//					"Harshana Eranga Martin");
//			
//			System.out.println(((SipUriID) new SipUriNamespace()
//			.createInstance(new Object[] { "sip:2233371083@sip2sip.info" })).getUser());
//			System.out.println(localParty.getInitiatorID());
//			
...
////System.out.println(new SipUriID(add.createSipURI("Harshana","Martin")));
//
